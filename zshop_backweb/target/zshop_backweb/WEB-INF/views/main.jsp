    ...
    $(function(){
    	// 点击切换页面
	     ...
	     $("#product-type-set").click(function() {
            $("#frame-id").attr("src", "${pageContext.request.contextPath}/back/productType/findAll");
        });
	        //切换至商品管理页面
            ...
            <div class="container-flude flude-cc" id="a">
                <div class="row user-setting">
                    ...
                    <div class="col-xs-10" id="userPanel">
                        <iframe id="frame-id" src="${pageContext.request.contextPath}/back/productType/findAll" width="100%" height="100%" frameborder="0" scrolling="no">
                        </iframe>
                    </div>
